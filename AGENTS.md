...
| `skills/group-dependabot-prs` | Consolidate a repo's separate Dependabot PRs into ONE grouped PR: install a grouping config, verify it validates, close the old ungrouped PRs, merge the config. |
